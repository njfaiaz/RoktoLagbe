    ...
    public function run(): void
    {
        Upazila::insert([
            ...
            [
                "id" => 492,
                "district_id" => 8,
                "upazila_name" => "Dhaka-North",
                "bn_name" => "ঢাকা নর্থ"
            ],
            [
                "id" => 493,
                "district_id" => 8,
                "upazila_name" => "Dhaka-South",
                "bn_name" => "ঢাকা সাউথ"
            ]
        ]);
    }
